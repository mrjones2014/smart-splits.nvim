...
local function resize(direction, amount)
  ...
  if (direction == 'left' or direction == 'right') and is_full_width() and mux.resize_pane(direction) then
    return
  end

  -- if a full height window and vertical resize check if we can resize with multiplexer
  if (direction == 'down' or direction == 'up') and is_full_height() and mux.resize_pane(direction) then
    return
  end
